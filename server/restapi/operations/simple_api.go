...
func NewSimpleAPI(spec *loads.Document) *SimpleAPI {
	return &SimpleAPI{
		...
		GetAccounts2Handler: GetAccounts2HandlerFunc(func(params GetAccounts2Params) middleware.Responder {
			return middleware.NotImplemented("operation GetAccounts2 has not yet been implemented")
		}),
	}
}
...
type SimpleAPI struct {
	...
	// GetAccounts2Handler sets the operation handler for the get accounts2 operation
	GetAccounts2Handler GetAccounts2Handler
...
func (o *SimpleAPI) Validate() error {
	...
	if o.GetAccounts2Handler == nil {
		unregistered = append(unregistered, "GetAccounts2Handler")
	}
...
func (o *SimpleAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/accounts2"] = NewGetAccounts2(o.context, o.GetAccounts2Handler)
